...
import 'CustomFloatingSearchBar.dart';
...
typedef CustomFloatingSearchBarBuilder = Widget Function(
...
class CustomFloatingSearchBar extends ImplicitlyAnimatedWidget {
  /// The widget displayed below the `CustomFloatingSearchBar`.
  ///
  /// This is useful, if the `CustomFloatingSearchBar` should react
  ...
  ///
  /// This can be used to position the `CustomFloatingSearchBar`.
  ///
  /// If not specifed, the `CustomFloatingSearchBar` will try to
  ...
  /// The max width of the `CustomFloatingSearchBar`.
  ///
  /// By default the `CustomFloatingSearchBar` will expand
  /// to fill all the available width. This value can
  /// be set to avoid this.
  final double? width;

  /// The max width of the `CustomFloatingSearchBar` when opened.
  ///
  ...
  /// the `CustomFloatingSearchBar` was closed.
  ///
  ...
  /// Whether the `CustomFloatingSearchBar` should be closed when
  ...
  ///
  /// When set to `true`, the `CustomFloatingSearchBar` will
  ...
  /// `CustomFloatingSearchBar` is closed.
  /// {@endtemplate}
  final Widget? title;
  ...
  /// actions that can interact with the `CustomFloatingSearchBar`.
  ///
  ...
  /// A callback that gets invoked when the `CustomFloatingSearchBar`
  ...
  /// The builder for the body of this `CustomFloatingSearchBar`.
  ///
  /// Usually, a list of items. Note that unless [isScrollControlled]
  /// is set to `true`, the body of a `CustomFloatingSearchBar` must not
  /// have an unbounded height meaning that `shrinkWrap` should be set
  /// to `true` on all [Scrollable]s.
  final CustomFloatingSearchBarBuilder builder;

  /// {@template floating_search_bar.controller}
  /// The controller for this `CustomFloatingSearchBar` which can be used
  /// to programatically open, close, show or hide the `CustomFloatingSearchBar`.
  /// {@endtemplate}
  final FloatingSearchBarController? controller;

  /// {@template floating_search_bar.textInputAction}
  /// The [TextInputAction] to be used by the [TextField]
  /// of this `CustomFloatingSearchBar`.
  /// {@endtemplate}
  ...
  /// Hides the `CustomFloatingSearchBar` intially for the specified
  ...
  // * --- Scrolling --- *
  /// Whether the builder of this `CustomFloatingSearchBar` is using its
  /// own [Scrollable].
  ///
  /// This will allow the body of the `CustomFloatingSearchBar` to have an
  /// unbounded height.
  ///
  ///
  ...
  final Widget Function(FloatingSearchAppBarState)? textFieldBuilder;
...
class FloatingSearchBarState extends ImplicitlyAnimatedWidgetState<
    FloatingSearchBarStyle, CustomFloatingSearchBar> {
  ...
  @override
  void didUpdateWidget(CustomFloatingSearchBar oldWidget) {
...
/// A controller for a [CustomFloatingSearchBar].
class FloatingSearchBarController {
  /// Creates a controller for a [CustomFloatingSearchBar].
  FloatingSearchBarController();

  FloatingSearchAppBarState? _appBarState;
  FloatingSearchBarState? _searchBarState;

  /// Opens/Expands the [CustomFloatingSearchBar].
  void open() => _appBarState?.open();

  /// Closes/Collapses the [CustomFloatingSearchBar].
  void close() => _appBarState?.close();

  /// Visually reveals the [CustomFloatingSearchBar] when
  /// it was previously hidden via [hide].
  void show() => _searchBarState?.show();

  /// Visually hides the [CustomFloatingSearchBar].
  void hide() => _searchBarState?.hide();

  /// Sets the query of the input of the [CustomFloatingSearchBar].
  ...
  /// The current query of the [CustomFloatingSearchBar].
  String get query => _appBarState?.query ?? '';

  /// Cleares the current query.
  void clear() => _appBarState?.clear();

  /// Whether the [CustomFloatingSearchBar] is currently
  /// opened/expanded.
